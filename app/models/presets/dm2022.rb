...
class Presets::Dm2022 < Preset
  ...
  def create_la_teams
    [
      [:female, '1', 'FF Kittlitz', 'Kittlitz', 1, 1, 'BB'],
      [:female, '2', 'FF Tüttleben', 'Tüttleben', 1, 1, 'TH'],
      [:female, '3', 'FF Urbach', 'Urbach', 1, 1, 'TH'],
      [:female, '4', 'Sachsenauswahl', 'Sachsen', 1, 1, 'SN'],
      [:female, '5', 'FF Beidendorf', 'Beidendorf', 1, 1, 'MV'],
      [:female, '6', 'Team Lausitz', 'Lausitz', 1, 1, 'BB'],
      [:female, '7', 'Perlen der Altmark', 'Altmark', 1, 1, 'ST'],
      [:female, '8', 'FF Groß Lübbenau', 'Lübbenau', 1, 1, 'BB'],
      [:female, '9', 'Team Mecklenburg-Vorpommern', 'Team MV', 1, 1, 'MV'],
      [:female, '10', 'Oberharz am Brocken', 'Oberharz', 1, 1, 'ST'],
      [:female, '11', 'FF Crosta', 'Crosta', 1, 1, 'SN'],
      [:female, '12', 'Team Benndorf/Wiedemar', 'Wiedemar', 1, 1, 'SN'],
      [:female, '13', 'Thüringenauswahl', 'Thüringen', 1, 1, 'TH'],
      [:female, '14', 'Team Brandenburg', 'Brandenburg', 1, 1, 'BB'],
      [:female, '15', 'FF Packebusch', 'Packebusch', 1, 1, 'ST'],
      [:female, '16', 'FF Gresse', 'Gresse', 1, 1, 'MV'],
      [:female, '17', 'Landkreis Rostock Nord', 'Team LRO', 1, 1, 'MV'],
      [:female, '18', 'FF Zella', 'Zella', 1, 1, 'TH'],
      [:female, '19', 'FF Taura', 'Taura', 1, 1, 'SN'],
      [:female, '20', 'FF Marolterode', 'Marolterode', 1, 1, 'TH'],
      [:male, '1', 'FF Kummer', 'Kummer', 1, 1, 'MV'],
      [:male, '2', 'FF Gamstädt', 'Gamstädt', 1, 1, 'TH'],
      [:male, '3', 'FF Zella', 'Zella', 1, 1, 'TH'],
      [:male, '4', 'FF Zottelstedt', 'Zottelstedt', 1, 1, 'TH'],
      [:male, '5', 'FF Stücken', 'Stücken', 1, 1, 'BB'],
      [:male, '6', 'Berlin', 'Berlin', 1, 1, 'BE'],
      [:male, '7', 'FF Beckwitz', 'Beckwitz', 1, 1, 'SN'],
      [:male, '8', 'FF Fahrendorf', 'Fahrendorf', 1, 1, 'ST'],
      [:male, '9', 'Berlin', 'Berlin', 2, 1, 'BE'],
      [:male, '10', 'Thüringenauswahl', 'Thüringen', 1, 1, 'TH'],
      [:male, '11', 'FF Taura', 'Taura', 1, 1, 'SN'],
      [:male, '12', 'FF Tryppehna', 'Tryppehna', 1, 1, 'ST'],
      [:male, '13', 'Team Lausitz', 'Lausitz', 1, 1, 'BB'],
      [:male, '14', 'FF Günthersdorf', 'Günthersdorf', 1, 1, 'BB'],
      [:male, '15', 'FF Niederalbertsdorf', 'Niederalb.', 1, 1, 'SN'],
      [:male, '16', 'FF Brünn', 'Brünn', 1, 1, 'TH'],
      [:male, '17', 'FF Niedersjesar', 'Niedersjesar', 1, 1, 'BB'],
      [:male, '18', 'FF Schwartow', 'Schwartow', 1, 1, 'MV'],
      [:male, '19', 'FF Dürrhennersdorf', 'Dürrhenners.', 1, 1, 'SN'],
      [:male, '20', 'Sachsenauswahl', 'Sachsen', 1, 1, 'SN'],
      [:male, '21', 'Team Mecklenburg-Vorpommern', 'Team MV', 1, 1, 'MV'],
      [:male, '22', 'Team Märkisch-Oderland', 'Team MOL', 1, 1, 'BB'],
      [:male, '23', 'FF Hohen Viecheln', 'H. Viecheln', 1, 1, 'MV'],
      [:male, '24', 'Perlen der Altmark', 'P. Altmark', 1, 1, 'ST'],
      [:male, '25', 'Berlin', 'Berlin', 3, 1, 'BE'],
      [:male, '26', 'FF Saalfeld', 'Saalfeld', 1, 1, 'TH'],
